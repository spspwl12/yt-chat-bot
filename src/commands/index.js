...
class CommandManager {
     ...
     * context.js 포함 관련 모듈 전체 캐시 삭제 후 fresh require
     */
    loadModules() {
        ...
        // 1패스: data 파일 및 commands 관련 모든 모듈 캐시 삭제
        ...
        // context.js fresh 재로딩
        this.context = require('./context.js');

        // 2패스: 모든 명령어 모듈 캐시 삭제 후 fresh require
        ...
        for (const file of files) {
            ...
            try {
                ...
                console.error(`❌ [CommandManager] 개별 모듈 로드 실패 (${file}):`, err.message);
            }
        }
    ...
    reload() {
        ...
        try {
            ...
            console.error('❌ [CommandManager] 핫리로드 실패:', err.message);
            return false;
        }
    }
...
module.exports = {
    ...
    get context() { return commandManager.context; }
};
